...
const ROTATION_INTERVAL_STORAGE_KEY = 'xpark-ai-perf:engine-rotation-interval'
const LATENCY_MODE_STORAGE_KEY = 'xpark-ai-perf:latency-mode'
const ACTIVE_TAB_STORAGE_KEY = 'xpark-ai-perf:active-tab'
